...
android {
    namespace = "com.multitrem.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.multitrem.app"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        buildConfigField("String", "KEYCLOAK_AUTH_SERVER_URL", "\"https://auth.rendacontinua.com/auth\"")
        buildConfigField("String", "KEYCLOAK_REALM", "\"auth_sso\"")
    }
