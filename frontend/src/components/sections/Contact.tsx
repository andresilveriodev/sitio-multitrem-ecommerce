...
export function Contact() {
  return (
    <>
      <section id="contato" className="py-20 sm:py-24 md:py-32 bg-background">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              ...
              {/* Card WhatsApp */}
              <Card variant="elevated" className="p-5 sm:p-6 mb-4 sm:mb-6 border-2 border-green-500/20">
              ...
              <Card variant="elevated" className="p-5 sm:p-6">
                <div className="flex items-start gap-4">
                  <div className="rounded-full bg-pink-100 p-3 sm:p-4 flex-shrink-0">
